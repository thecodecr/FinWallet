                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FlutterFlowAdBanner(
                        width: MediaQuery.sizeOf(context).width * 1.013,
                        height: 43.0,
                        showsTestAd: true,
                        androidAdUnitID:
                            'ca-app-pub-9075772695268179/6539858195',
                      ),
                      FlutterFlowAdBanner(
                        width: MediaQuery.sizeOf(context).width * 1.0,
                        height: 50.0,
                        showsTestAd: true,
                        androidAdUnitID:
                            'ca-app-pub-9075772695268179/3392618971',
                      ),
                      FlutterFlowAdBanner(
                        width: MediaQuery.sizeOf(context).width * 1.0,
                        height: 148.0,
                        showsTestAd: true,
                        androidAdUnitID:
                            'ca-app-pub-9075772695268179/2543533162',
                      ),
                      FlutterFlowAdBanner(
                        width: MediaQuery.sizeOf(context).width * 1.0,
                        height: 50.0,
